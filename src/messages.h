...
static char* messages[] =
{
  ...
  "A section of glowing phosphor cells sing a song about radiation to you.",
  "The unplugged TRS-80 III fails to be a good conversationalist.",
  "A toilet bowl occupies this space.",
  "Tim the Enchanter sits, knowing much that is hidden.",
  "It's a solitary vaccuum tube.",
  "Particle man does the things a particle can.",
  "\"Hi, I'm Anson Williams, TV's 'Potsy'.\"",
  "Looks like a power converter from Taashi Station.",
  ...
  "Whoever they are, they're happy because they eat LARD.",
  ...
  "Shoot. Thought it was kitten, but it was an exploded pen.",
  ...
  "A robot comedian. Dang, if that servo bit wasn't hilarious!",
  "It's KITT, the automated car... You were close, though.",
